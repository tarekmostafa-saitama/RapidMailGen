...
export interface IMailboxClient {
    ...
    getAllMessages(name: string, token: string): Observable<GetMailBoxMailsResponseModel>;
}
...
export class MailboxClient implements IMailboxClient {
        ...
        return this.http.request("post", url_, options_).pipe(_observableMergeMap((response_ : any) => {
            ...
            if (response_ instanceof HttpResponseBase) {
                try {
                    ...
                    return _observableThrow(e) as any as Observable<CreateMailBoxResponseModel>;
                }
            } else
                return _observableThrow(response_) as any as Observable<CreateMailBoxResponseModel>;
        }));
    }
    ...
    protected processCreate(response: HttpResponseBase): Observable<CreateMailBoxResponseModel> {
        ...
        return _observableOf<CreateMailBoxResponseModel>(null as any);
    }
        ...
        return this.http.request("get", url_, options_).pipe(_observableMergeMap((response_ : any) => {
            ...
            if (response_ instanceof HttpResponseBase) {
                try {
                    ...
                    return _observableThrow(e) as any as Observable<GetMailBoxMailsResponseModel>;
                }
            } else
                return _observableThrow(response_) as any as Observable<GetMailBoxMailsResponseModel>;
        }));
    }
    ...
    protected processGetAllMessages(response: HttpResponseBase): Observable<GetMailBoxMailsResponseModel> {
        ...
        return _observableOf<GetMailBoxMailsResponseModel>(null as any);
    }
}
